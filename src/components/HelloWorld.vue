    ...
    <div class="pdf-ctn">
        <div class="pdf-panel">
            <div class="pdf-inside-panel">
                <TableComponent v-for="(item ,index) in 5" :key="index" ></TableComponent>
                <ImageComponent v-for="(item,index) in 4" :key="index + 6"></ImageComponent>
                <RichText v-for="(item, index) in 4" :key="index + 20"></RichText>
            </div>
        </div>
